...
class SppCanvasAgentsFactory extends CommonCanvasAgentsFactory {

    public SppCanvasAgentsFactory(CommonScenarioSettings scenarioSettingsLocator, CommonInputService commonInputService) {
        super(scenarioSettingsLocator, commonInputService);
    }
