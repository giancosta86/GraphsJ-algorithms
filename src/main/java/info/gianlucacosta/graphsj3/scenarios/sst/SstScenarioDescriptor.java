...
/**
 * SST scenario descriptor
 */
public class SstScenarioDescriptor implements ScenarioDescriptor {

    @Override
    public String getName() {
        return "Prim's shortest-spanning tree (SST) algorithm";
    }

    @Override
    public Scenario createScenario() {
        return new SstScenario();
    }
