...
class SstCanvasAgentsFactory extends CommonCanvasAgentsFactory {

    public SstCanvasAgentsFactory(CommonScenarioSettings scenarioSettings, CommonInputService commonInputService) {
